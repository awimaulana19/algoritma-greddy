            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    @if (auth()->user()->roles == 'admin')
                        ...
                        <li @if (request()->route()->uri == 'admin-jadwal-dokter') class="menu-item active" @else class="menu-item" @endif>
                        ...
                        <li @if (request()->route()->uri == 'admin-antrian-pasien') class="menu-item active" @else class="menu-item" @endif>
                    ...
                    @elseif(auth()->user()->roles == 'petugas')
                        ...
                        <li @if (request()->route()->uri == 'antrian-dokter') class="menu-item active" @else class="menu-item" @endif>
